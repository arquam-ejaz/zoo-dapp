...
var CONTRACT_NAME = 'zoo-dapp.aejaz.testnet';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            window.walletConnection = new _nearApiJs.WalletConnection(near, nearConfig.contractName); // Getting the Account ID. If still unauthorized, it's just empty string
          ...
          case 7:
            ...
            _context.next = 10;
            return near.account(window.accountId);

          case 10:
            window.senderAccount = _context.sent;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 10:
          md = _context.sent;
          console.log(md);
          if (gd || ld || md) showNotification(); // if (donated) {
          //   showNotification();
          //   gd = true;
          // } else {
          //   donated = await window.contract.nft_token({
          //     token_id: window.accountId + 'l'
          //   });
          //   if (donated) {
          //     showNotification();
...
function gformSubmit(_x) {
  return _gformSubmit.apply(this, arguments);
}

function _gformSubmit() {
  _gformSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
    var amt;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            event.preventDefault();
            amt = document.getElementById('gi').value;
            amt = _nearApiJs.utils.format.parseNearAmount(amt.toString()).toString();
            _context2.prev = 3;
            _context2.next = 6;
...
function lformSubmit(_x2) {
  return _lformSubmit.apply(this, arguments);
}

function _lformSubmit() {
  _lformSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
    var amt;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            event.preventDefault();
            amt = document.getElementById('li').value;
            amt = _nearApiJs.utils.format.parseNearAmount(amt.toString()).toString();
            _context3.prev = 3;
            _context3.next = 6;
            return window.contract.nft_mint({
...
function mformSubmit(_x3) {
  return _mformSubmit.apply(this, arguments);
}

function _mformSubmit() {
  _mformSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(event) {
    var amt;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            event.preventDefault();
            amt = document.getElementById('mi').value;
            amt = _nearApiJs.utils.format.parseNearAmount(amt.toString()).toString();
            _context4.prev = 3;
            _context4.next = 6;
            return window.contract.nft_mint({
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","bn.js":"../node_modules/bn.js/lib/bn.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
